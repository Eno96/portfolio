        ...
        <div className = "container-fluid" id = "portofolio">
          <div className = "row pt-5">
            <div className = "col-sm-11 offset-1 portofoliotext">
              <h2><img src={Portofolioheaderdots} className="img-fluid"/>Portofolio<span></span></h2>
            </div> 
            <div className = "col-sm-10 offset-1 portofoliodesc">

              <div className = "row">
                  <div className = "col-sm">
                    <a href="#" target="_blank"><img src={Moviearc} className = "img-fluid" alt = "MovieArc"/></a>
                    <h3>MovieArc</h3>
                    <p>New React Native app in progress.</p>
                    <p>Suggesting a film depending on the mood and genre.</p>
                  </div>    
                  <div className = "col-sm">
                    <a href="https://play.google.com/store/apps/details?id=com.partnerjobstep&hl=en&gl=US" target="_blank"><img src={Jobsteppartner} className = "img-fluid" alt = "Jobstep Partner APP"/></a>
                    <h3>Jobstep Partner APP</h3>
                    <p>The Jobstep Partner App is a Jobstep</p>
                    <p>outsourcing application</p>
                  </div>     
                  <div className = "col-sm">
                    <a href="https://play.google.com/store/apps/details?id=com.phonegap.RandomPicker&hl=en&gl=US" target="_blank"><img src={Randompicker} className = "img-fluid" alt = "Random Picker App"/></a>
                  ...
                  <div className = "col-sm">
                    <a href="https://farmfresh.ba/cms/login" target="_blank"><img src={FarmfreshCMS} className = "img-fluid" alt = "FarmFresh CMS"/></a>
                    <h3>FarmFresh CMS</h3>
                ...
                <div className = "row pt-5">
                  <div className = "col-sm">
                    <a href="https://farmfresh.ba" target="_blank"><img src={FarmfreshSite} className = "img-fluid" alt = "FarmFresh shop"/></a>
                    <h3>FarmFresh shop</h3>
                    <p>Farm Fresh is a retail distributor of domestic.</p>
                    <p>products.</p>
                  </div>    
                  <div className = "col-sm">
                    <a href="#" target="_blank"><img src={TruckByEA} className = "img-fluid" alt = "Truck by EA"/></a>       
                    <h3>Truck by EA</h3>
                  ...
                  <div className = "col-sm">
                    <a href="https://play.google.com/store/apps/details?id=ba.wwtcm&hl=en&gl=US" target="_blank"><img src={Wwtcm} className = "img-fluid" alt = "WWT Channel Manager"/></a> 
                  ...
                  <div className = "col-sm">
                    <a href="https://github.com/Eno96/Break-Counter" target="_blank"><img src={BreakCounter} className = "img-fluid" alt = "Break Counter"/></a> 
                    <h3>Break Counter</h3>
